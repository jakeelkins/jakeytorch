...
int main(){
    ...
    // A_T comes out NxP
    _batched_transpose(A_T.data(), A.data(), P, N, batch_size);
    
    _batched_gemm(C_ref.data(), A_T.data(), B.data(), N, P, M, batch_size);

    //printf("A: \n");
    //batched_print_matrix(A, P, N, batch_size);

    //printf("B: \n");
    //batched_print_matrix(B, P, M, batch_size);
